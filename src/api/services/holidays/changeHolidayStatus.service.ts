...
export const changeHolidayStatus = async (holidayId: string, userRole: Roles, actionType: HolidayStatusAction) => {
    if (actionType === HolidayStatusAction.ACCEPT) {
        ...
        await updateHolidayStatus(holidayId, HolidayStatus.REJECTED);
    }
};
